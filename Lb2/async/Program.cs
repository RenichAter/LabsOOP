...
class async
{
    static async Task Main()
    {
        ...
        File.WriteAllText("sites_lovecraft1.json", await Task.Content.ReadAsStringAsync());
        ...
        File.WriteAllText("sites_lovecraft2.json", await Task.Content.ReadAsStringAsync());
        ...
        File.WriteAllText("sites_lovecraft3.json", await Task.Content.ReadAsStringAsync());
